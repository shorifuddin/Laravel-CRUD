        ...
        <div class="card-header bg-secondary card_header">
            <div class="row">
              ...
              <div class="col-md-4 card_header_btn ">
                <a href="{{ route('adduser') }}" class="btn btn-xs btn-dark " style="float: right; color:white;"><i class="md md-view-module"></i> Add User</a>
              </div>
            </div>
        </div>
<br>
								...
								<td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" style="">
                                            <a class="dropdown-item" href="{{ route('edituser',$data->staff_id) }}">Edit</a>
                                            <a class="dropdown-item" href="{{ route('viewuser',$data->staff_id) }}">View</a>
                                            <a class="dropdown-item" href="{{ route('softdeleteuser',$data->staff_id) }}" data-bs-toggle="modal" data-bs-target="#dark-header-modal">Delete</a>
                                        </div>
                                    </div>
                                    </div>
                                </td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <a href="{{ route('softdeleteuser',$data->staff_id) }}" class="btn btn-dark">Yes</a>
                                        </div>
                                    </div><!-- /.modal-content -->
                                </div><!-- /.modal-dialog -->
                            </div>
