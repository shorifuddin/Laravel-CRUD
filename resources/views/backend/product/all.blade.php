        ...
        <div class="card-header bg-secondary card_header">
            <div class="row">
              <div class="col-md-8 card_header_title">
                <i class="md md-add-circle "></i> All Product Information
              </div>
              <div class="col-md-4 card_header_btn ">
                <a href="{{ route('product.create') }}" class="btn btn-xs btn-dark " style="float: right; color:white;"><i class="md md-view-module"></i> Add Product</a>
              </div>
            </div>
        </div>
<br>
								...
								<td>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu" style="">
                                            ...
                                            <a class="dropdown-item" href="{{ route('product.show',$data->id) }}">View</a>
                                            <a class="dropdown-item" href="{{ route('product.destroy',$data->id) }}" data-bs-toggle="modal" data-bs-target="#dark-header-modal{{ $data->id }}" >Delete</a>
                                        </div>
                                    </div>
                                    </div>
                                </td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <form id="delete-form" action="{{ route('product.destroy',$data->id) }}" method="POST" style="display: none;">
                                                @csrf
                                                @method('DELETE')
